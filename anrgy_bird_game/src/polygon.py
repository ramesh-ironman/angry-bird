...
class Polygon():
    def __init__(self, pos, length, height, space, mass=5.0):
        ...
        self.body = body
        self.shape = shape
        wood = pygame.image.load(r"C:\Users\90432\all coding\PYTHON COURSE\projects\anrgy_bird_game\resources\images\wood.png").convert_alpha()
        wood2 = pygame.image.load(r"C:\Users\90432\all coding\PYTHON COURSE\projects\anrgy_bird_game\resources\images\wood2.png").convert_alpha()
